 ...
 */
package View.Professor.Cadastro;
...
public class CadastroProfessor extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        professor.setNome(jTextField1.getText().toUpperCase());
        professor.setCpf(jTextField2.getText().toUpperCase());
        professor.setDepartamento(jTextField3.getText().toUpperCase());
        professorDao.inserir(professor);
        
        //fazer botão de volta
